...
if (!function_exists('qontak_whatsapp_helper_remainder_inv')) {
    function qontak_whatsapp_helper_remainder_inv($phone, $name, $customer_id, $invoice_no, $amount, $billing_month, $due_date, $url)
    {
        if (env('WAPISENDER_STATUS') !== "disable") {
            ...
            // cek apakah no hp karakter ke 1 adalah angka 0
                ...
                $payload = [
                    "to_number" => $hp,
                    "to_name" => $name,
                    "message_template_id" => env('WA_TAMPLATE_ID_1'),
                    ...
                    "parameters" => [
                        "body" => [
                            ...
                            ["key" => "4", "value" => "amount", "value_text" => "Rp. " . number_format($amount, 0, ',', '.')],
