...
// $(".jurnal-transaction").on("click", function(e) {
// 	e.preventDefault();

//     // Menargetkan form dengan nama 'transaction'
// 	const form = $("form[name='transaction']");

// 	Swal.fire({
// 		title: 'Are you sure?',
// 		text: "You want to create this transaction",
// 		icon: 'warning',
// 		showCancelButton: true,
// 		confirmButtonColor: '#3085d6',
// 		cancelButtonColor: '#d33',
// 		confirmButtonText: 'Yes, Send it!'
// 	}).then((result) => {
//         if (result.isConfirmed) { // Menggunakan isConfirmed untuk memeriksa hasil
//             form.submit(); // Mengirimkan form yang ditargetkan
//         }
//     });
// });
...
// $(".kasbank-create").on("click", function(e) {
// 	e.preventDefault();
// 	Swal.fire({
// 		title: 'You want create thist transactioncc?',
// 		text: "",
// 		icon: 'warning',
// 		showCancelButton: true,
// 		confirmButtonColor: '#3085d6',
