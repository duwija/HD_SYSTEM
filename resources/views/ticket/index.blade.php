    ...
    <div class="card-header">
     ...
     <!--  @if (empty($date_from))
      <form role="form" method="post" action="/ticket/search">
        ...
        <div class="form-group col-md-1">
            <label for="site location">  Ticket ID </label>
     ...
     <div class="form-group col-md-2">
        <label for="site location">  Tags </label>
        <div class="input-group mb-3 p-1">
...
<div class="form-group col-md-2">
    ...
    <div class="input-group ">
        ...
        <button type="submit" class="btn m-3   bg-gradient-primary  btn-primary"  id="ticket_filter" name="ticket_filter">Filter
        </button>
    </div> 
</div> 
<!-- <div class="form-group col-md-1">
...
<!-- /.card-header -->
<div class="card-body">
  <table id="table-ticket-list" class="table table-bordered table-striped">
