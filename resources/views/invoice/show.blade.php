    ...
    <div class="card-body row">
      ...
      <table class="table table-borderless col-md-6 table-sm">
        ...
        <tbody>
          ...
          <tr class="col-md-6">
            <tr>
              <td><span>  <a  href="/invoice/cst/{{$encryptedurl}}" target="_blank"> Encrypted Url</a></span> </td>
            </tr>
            <tr>
